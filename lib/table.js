(function() {
  ...
  module.exports = MySQLTable = (function(superClass) {
    ...
    MySQLTable.prototype._crement = function(id, field, count, cb, opt) {
      ...
      _data = this._checkAndAddIncrementOnSave(_data, sql);
    ...
    MySQLTable.prototype._checkAndAddIncrementOnSave = function(data, sql) {
      var _fn, field, ref, ref1;
      ref = sql.attrs;
      for (_fn in ref) {
        field = ref[_fn];
        if (field != null ? (ref1 = field.validation) != null ? ref1.incrementOnSave : void 0 : void 0) {
          data[field.name] = "incr";
        }
      }
      return data;
