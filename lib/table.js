(function() {
  var MySQLTable, async, bcrypt, moment, utils, _, _joinTypes,
  ...
  module.exports = MySQLTable = (function(_super) {
    ...
    function MySQLTable(settings, options) {
      ...
      this._addJoin = __bind(this._addJoin, this);
    ...
    MySQLTable.prototype.find = function(filter, cb, opt) {
      var jField, jSett, options, sql, _ref;
      if (opt == null) {
        opt = {};
      }
      cb = this._wrapCallback(cb);
    ...
    MySQLTable.prototype._addJoin = function(sql, ownField, jSett, cb) {
      ...
      if ((ownField == null) && __indexOf.call(sql.fieldNames, ownField) < 0) {
      ...
      if (_ref = jSett.type.toLowerCase(), __indexOf.call(_joinTypes, _ref) < 0) {
        this._handleError(cb, "invalid-join-type", {
          self: this.tablename,
          foreign: (_ref1 = jSett.table) != null ? _ref1.tablename : void 0
        });
        return false;
      }
    ...
    MySQLTable.prototype._crement = function(id, field, count, cb, opt) {
      var options, sql, stmt, _data, _fields, _type;
      if (opt == null) {
        opt = {};
      }
      cb = this._wrapCallback(cb);
    ...
    MySQLTable.prototype._validateField = function(field, value, args) {
      ...
      return (function(_this) {
        return function(cb) {
          var salt, _base, _base1, _name, _name1, _ref, _ref1, _ref2, _validation;
          ...
          if ((options != null ? options.equalOldValueIgnore : void 0) !== true && _validation.equalOldValue === true && isUpdate === true) {
            ...
            if (((_ref2 = field.type) === "D" || _ref2 === "date") && _.isString(value)) {
